                ...
                <div class="modal-body">
                    ...
                    <form id="formulario_responder_tramite" class="row" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="numero_hojas" id="numero_hojas"
                                    onkeypress="return soloNumeros(event)" placeholder="Ingrese la cantidad de hojas">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control uppercase-input" name="instructivo"
                                    id="instructivo" placeholder="Ingrese el instructivo">
                    ...
                    <div class="col-12 text-center demo-vertical-spacing">
                        ...
                        <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close"
                            onclick="vaciar_formulario_responder()">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form id="formulario_archivar" class="row" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                                ...
                                <textarea name="descripcion_archivar" id="descripcion_archivar" cols="30" rows="3"
                                    class="form-control uppercase-input" placeholder="Ingrese la descripcion, por el cual esta archivando"></textarea>
                        ...
                        if (dato.tipo === 'errores') {
                            ...
                            for (let key in obj) {
                                document.getElementById('_' + key).innerHTML =
                                    `<p class="text-sm text-danger" >` + obj[
                                        key] + `</p>`;
                            }
                        }
                        if (dato.tipo === 'success') {
